...
function ProfilePage() {
    ...
    return (
        <div className="min-h-screen bg-gray-900 text-white">
            <div className="relative h-60 md:h-72 lg:h-80 bg-cover bg-center"
            ...
            >
                ...
                <div className="absolute bottom-4 left-6 flex items-center">
                    ...
                    />
                    <div className='ml-4'>
                        <h1 className='text-2xl md:text-3xl lg:text-4xl font-bold'>{userData.fullName}</h1>
                        <p className="text-sm md:text-base text-gray-300">@{userData.userName}</p>
                    </div>
                </div>
            </div>
            ...
            <div className="px-4 md:px-8 lg:px-8 pt-2">
                ...
                <h2 className="text-xl md:text-2xl font-semibold mt-2">Continue Watching for {userData.fullName.split(" ")[0]}</h2>
