...
function Slider() {
    ...
    return (
        <div>
            <ChevronLeft onClick={()=>handleSlide("left")}  className='hidden md:block text-white text-[30px] absolute left-10 top-[40%] transform -translate-y-[40%] cursor-pointer '/>
            <ChevronRight onClick={()=>handleSlide("right")}  className='hidden md:block text-white text-[30px] absolute right-8 top-[40%] transform -translate-y-[40%] cursor-pointer'/>
